                        ...
                        <tr class="hover:bg-slate-900/20 transition-colors">
                            ...
                            <td class="py-4 px-6 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <a href="<?= base_url('admin/officer/delete/' . $off['id']) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus petugas ini?')" class="p-1.5 bg-rose-500/10 hover:bg-rose-500 text-rose-400 hover:text-white rounded-lg transition-colors border border-rose-500/20" title="Hapus">
