...
$subtitle = 'Definisikan Jarak & Estimasi Waktu Perjalanan';
?>
...
<div class="max-w-xl bg-slate-900/60 border border-slate-800/80 p-6 sm:p-8 rounded-3xl shadow-xl">
    ...
    <form action="<?= base_url('admin/route/store') ?>" method="POST" class="space-y-6">
        <?= csrf_field() ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="origin" name="origin" type="text" required value="<?= old('origin') ?>"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="destination" name="destination" type="text" required value="<?= old('destination') ?>"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="distance_km" name="distance_km" type="number" step="0.01" required value="<?= old('distance_km') ?>"
                        class="block w-full pl-10 pr-3 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 placeholder-slate-655 focus:outline-none focus:ring-2 focus:ring-brand-500 text-sm"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="estimated_duration" name="estimated_duration" type="number" required value="<?= old('estimated_duration') ?>"
                        class="block w-full pl-10 pr-3 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 placeholder-slate-655 focus:outline-none focus:ring-2 focus:ring-brand-500 text-sm"
        ...
        <div class="pt-4 flex flex-col sm:flex-row gap-3">
            <button type="submit" class="w-full sm:w-auto flex justify-center items-center py-2.5 px-6 rounded-xl font-semibold text-white bg-brand-600 hover:bg-brand-500 shadow-lg shadow-brand-600/10 gap-2 transition-all text-sm">
                <i data-lucide="check-circle" class="w-4 h-4"></i> Simpan Rute
            </button>
